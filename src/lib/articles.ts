...
export const articles = [
  ...
  { slug: "sammenligning-af-laanetyper", title: "Lånetyper: realkredit, banklån og afdragsfrihed", description: "Sammenlign realkredit og banklån, fast og variabel rente, afdragsfrihed og tinglysning – og test tallene i boligberegneren." },
