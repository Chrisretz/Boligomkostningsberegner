...
export const articles = [
  ...
  { slug: "realkreditlan-beregner", title: "Realkreditlån beregner: Overblik over boligomkostninger", description: "Brug boligomkostningsberegneren som realkreditlån beregner: ydelse, 80/15/5, banklån, tinglysning og vedligehold — gratis uden login." },
  ...
  { slug: "ejerudgifter", title: "Hvad dækker ejerudgifter? Komplet guide til boligejere", description: "Grundskyld, ejendomsværdiskat, forsikring, ejerforeningsbidrag og hvad der ikke er ejerudgifter – med tabel, FAQ og links til beregneren." },
  ...
  { slug: "tvangsauktioner", title: "Tvangsauktioner: guide til muligheder og faldgruber", description: "Hvad en tvangsauktion er, fordele og risici, typisk forløb, økonomi og finansiering – og hvordan du bruger Boligklarheds beregnere." },
] as const;
