...
export const articleCategories = [
  ...
  { id: "finansiering", title: "Finansiering og lån", description: "Realkreditlån, banklån og hvad du har råd til at købe for.", slugs: ["realkreditlan", "hvad-kan-jeg-koebe-bolig-for", "saadan-vurderer-banken-dit-boliglan"] as const },
  { id: "loebende", title: "Løbende omkostninger", description: "Vedligehold, ejerudgifter, el, grundskyld, skat og forsikring.", slugs: ["vedligehold", "ejerudgifter", "elforbrug-husstand", "grundskyld-og-ejendomsskat", "indboforsikring"] as const },
