...
export const articles = [
  ...
  { slug: "elforbrug-husstand", title: "Hvor meget strøm bruger en familie?", description: "Gennemsnitligt elforbrug for 1-5 personer i hus og lejlighed – i kWh om året og kroner om måneden." },
...
export const STARTER_SLUGS = [
  ...
  "saadan-vurderer-banken-dit-boliglan",
  "tinglysning",
  "ejerudgifter",
] as const;
